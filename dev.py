...
## TODO: Change this pathing to be universal amond users. It might be helpful to look at tesseract-OCR's installation manual and how they suggest setting the path.
pytesseract.pytesseract.tesseract_cmd = 'C:\\Users\\svand\\AppData\\Local\\Tesseract-OCR\\tesseract.exe'

## TODO: Make some sort of GUI for the player to interact with where they can login and store their own profiles. For now we will just import a test player object to work with.
player = Player()
